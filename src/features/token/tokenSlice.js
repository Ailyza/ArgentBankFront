...
const tokenSlice = createSlice({
	...
	initialState: {
		// defini la valeur initiale de l'etat qui est créer
...
export const getUser = (state) => state.token.user;

export const { setAccessToken, clearAccessToken, setUser } = tokenSlice.actions;
